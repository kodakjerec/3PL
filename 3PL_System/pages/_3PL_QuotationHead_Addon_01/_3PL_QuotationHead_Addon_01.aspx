<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_3PL_QuotationHead_Addon_01.aspx.cs"
    Inherits="_3PL_System._3PL_QuotationHead_Addon_01" %>

<head>
    <script type="text/javascript" src="/3PL/js/CommonLoader.js"></script>
    <script type="text/javascript" src="./_3PL_QuotationHead_Addon_01.js"></script>
    <title>短期寄倉收費</title>
</head>
<body>
    <table class="tborder" style="width: 100%">
        <tr>
            <td class="PageTitle">短期寄倉收費
            </td>
        </tr>
    </table>
    <div id="div1">
    ...
    <div id="div_EditDialog">
        <span style="color: blue">短期寄倉內容</span>
        <table class="tborder">
            <tr>
