    ...
    $.fn.runAjax(
        ...
        , ht1, function (response) {
            ...
            $.each(response, function (key, value) {
                ...
                colNames.push("移動");
                colModel.push({ name: "DisplayOrder", index: "DisplayOrder", hidden: false, sorttype: 'number', formatter: setGridDetail_moveButtons, key: true });
            });
            ...
            $("#jqGrid_Detail").jqGrid({
                ...
                sortorder: 'asc',
                footerrow: true,
                loadComplete: setGridDetail_loadComplete,
...
//統計小計 loadcomplete
function setGridDetail_loadComplete() {
    var grid = $("#jqGrid_Detail");
    var Origindata = grid.jqGrid('getGridParam', 'data');
    var sum = 0;
    $.each(Origindata, function (key, value) {
    ...
    grid.jqGrid('footerData', 'set', { Price: sum });
}
...
function div_EditDialog_btn_Print() {
    $.fn.runAjax(
         ...
         , [
             ...
             , { Name: '@pageType', Value: DefaultPageType }
